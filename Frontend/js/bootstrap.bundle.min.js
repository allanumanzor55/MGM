...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = e() }(this, (function() {
    ...
    const t = {
        ...
        n = t => { const e = i(t); return e && document.querySel(e) ? e : null },
        s = t => { const e = i(t); return e ? document.querySel(e) : null },
        o = t => {
            if (!t) return 0;
    ...
    function S(t, e, i = null) { const n = Object.keys(t); for (let s = 0, o = n.length; s < o; s++) { const o = t[n[s]]; if (o.originalHandler === e && o.delegationSel === i) return o } return null }
    ...
    function j(t, e, i, n, s) {
        ...
        u.delegationSel = o ? i : null, u.originalHandler = r, u.oneOff = s, u.uidEvent = h, c[h] = u, t.addEventListener(a, u, o)
    }
    ...
    const H = {
        ...
        off(t, e, i, n) {
            ...
            c && Object.keys(l).forEach(i => {
                ! function(t, e, i, n) {
                    ...
                    Object.keys(s).forEach(o => {
                        if (o.includes(n)) {
                            const n = s[o];
                            P(t, e, i, n.originalHandler, n.delegationSel)
                        }
                    })
                }(t, l, i, e.slice(1))
            });
            ...
            Object.keys(d).forEach(i => {
                ...
                if (!a || e.includes(n)) {
                    const e = d[i];
                    P(t, l, r, e.originalHandler, e.delegationSel)
                }
            })
        },
        trigger(t, e, i) {
    ...
    class J extends R {
        constructor(e, i) {
            ...
            for (let e = 0, i = s.length; e < i; e++) {
                ...
                null !== o && r.length && (this._sel = o, this._triggerArray.push(i))
            }
    ...
    var Nt = {
            ...
            effect: function(t) {
                ...
                null != n && ("string" != typeof n || (n = e.elements.popper.querySel(n))) && _t(e.elements.popper, n) && (e.elements.arrow = n)
            },
    ...
    class Xe extends R {
        ...
        _setListeners() {
            this._config.trigger.split(" ").forEach(t => {
                if ("click" === t) H.on(this._element, this.constructor.Event.CLICK, this._config.sel, t => this.toggle(t));
                else if ("manual" !== t) {
                    const e = "hover" === t ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
                        i = "hover" === t ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                    H.on(this._element, e, this._config.sel, t => this._enter(t)), H.on(this._element, i, this._config.sel, t => this._leave(t))
                }
            }), this._hideModalHandler = () => { this._element && this.hide() }, H.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this._config.sel ? this._config = {...this._config, trigger: "manual", sel: "" } : this._fixTitle()
        }
        _fixTitle() {
    ...
    class ii extends R {
        ...
        refresh() {
            ...
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), t.find(this._sel).map(e => {
                const o = n(e),
        ...
        _activate(e) {
            ...
            const i = this._sel.split(",").map(t => `${t}[data-bs-target="${e}"],${t}[href="${e}"]`),
                n = t.findOne(i.join(","));
        ...
        _clear() { t.find(this._sel).filter(t => t.classList.contains("active")).forEach(t => t.classList.remove("active")) }
        static jQueryInterface(t) {
            return this.each((function() {
