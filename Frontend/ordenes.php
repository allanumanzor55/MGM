    ...
    <div class="container-fluid bg-opacity min-vh-100 w-100">
        ...
        <main class="row px-5 min-vh-100">
            <div class="align-items-start bg-light min-vh-100 pt-2">
                ...
                <div class=" tab-content min-vh-50" id="pills-tabContentOrdenes">
                    <div class="tab-pane show active" id="tab-ordenes" role="tabpanel" aria-labelledby="ingresarInventarioFinalTab">
                        <div class="d-flex justify-content-between my-2">
                            ...
                            <?php
                                ...
                                $db = new Conexion();
                                $cnn = $db->getConexion();
                                $p = intval(Login::obtenerPermiso($cnn,'pedido'));
                                echo 
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive table-hover text-center" id="tableOrdenes">
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-3">
                                    ...
                                    <form id="formOrdenes" class="row g-3" enctype="multipart/form-data">
                                        <input type="hidden" name="id" id="idOrdenes">
                                        <input type="hidden" name="descripcionOrdenes" id="descripcionOrdenes">
                                ...
                                <div class="col-9">
                                    <div class="row justify-content-center my-3">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <div class="col-3">
                                                <a class="btn btn-outline-warning" style="display: block !important;">
                                                    <i class="zmdi zmdi-shopping-cart"></i>
                                                    <div class="d-none d-sm-none d-md-block"> Solicitar Ordenes</div>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
